    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('matakuliah.store', $matakuliah->kode_matakuliah) }}" enctype="multipart/form-data" class="mt-6 space-y-6">
                    @csrf

                    <div class="max-w-xl">
                        <x-input-label for="kode_matakuliah" value="KODE"/>
                        <x-text-input id="kode_matakuliah" type="text" name="kode_matakuliah" class="mt-1 block w-full" value="{{ substr(old('kode_matakuliah', $matakuliah->kode_matakuliah), 2)}}" required/>
                    ...
                    <div class="max-w-xl">
                        ...
                        <x-text-input id="nama_matakuliah" type="text" name="nama_matakuliah" class="mt-1 block w-full" value="{{ old('nama_matakuliah', $matakuliah->nama_matakuliah)}}" required/>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        href="{{ route('matakuliah.index', $matakuliah->kode_matakuliah) }}">Cancel</a>
